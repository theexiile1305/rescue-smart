    ...
    <div className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-600">
          {/* Präambel */}
          <section id="m716">
            <h2 className="text-lg font-semibold text-slate-900">Präambel</h2>
            <p className="mt-2">
          ...
          <section>
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              <li>
                <a href="#m716" className="hover:text-primary-700 underline">
                  Präambel
                </a>
              </li>
              <li>
                <a href="#m3" className="hover:text-primary-700 underline">
                  Verantwortlicher
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#m2427" className="hover:text-primary-700 underline">
                  Maßgebliche Rechtsgrundlagen
                </a>
              </li>
              <li>
                <a href="#m27" className="hover:text-primary-700 underline">
                  Sicherheitsmaßnahmen
                </a>
              </li>
              <li>
                <a href="#m25" className="hover:text-primary-700 underline">
                  Übermittlung von personenbezogenen Daten
                </a>
              </li>
              <li>
                <a href="#m24" className="hover:text-primary-700 underline">
                  Internationale Datentransfers
                </a>
              </li>
              <li>
                <a href="#m12" className="hover:text-primary-700 underline">
                  Allgemeine Informationen zur Datenspeicherung und Löschung
                </a>
              </li>
              <li>
                <a href="#m10" className="hover:text-primary-700 underline">
                  Rechte der betroffenen Personen
                </a>
              </li>
              <li>
                <a href="#m317" className="hover:text-primary-700 underline">
                  Geschäftliche Leistungen
                </a>
              </li>
              <li>
                <a href="#m225" className="hover:text-primary-700 underline">
                  Bereitstellung des Onlineangebots und Webhosting
                </a>
              </li>
              <li>
                <a href="#m182" className="hover:text-primary-700 underline">
                  Kontakt- und Anfrageverwaltung
                </a>
              </li>
              <li>
                <a href="#m2324" className="hover:text-primary-700 underline">
                  Datenschutzinformationen für Hinweisgeber
                </a>
              </li>
              <li>
                <a href="#m15" className="hover:text-primary-700 underline">
                  Änderung und Aktualisierung
                </a>
              </li>
              <li>
                <a href="#m42" className="hover:text-primary-700 underline">
          ...
          <section id="m3">
            ...
            <p className="mt-2">
              Impressum:{" "}
              <a
                href="https://rescuesmart.de/impressum"
                className="hover:text-primary-700 underline"
              >
                https://rescuesmart.de/impressum
              </a>
            </p>
          </section>
          ...
          <section id="m2427">
            ...
            <p className="mt-2">
              ...
              Sie zu beachten, dass aufgrund der breiteren räumlichen Anwendung
          ...
          <section id="m25">
            ...
            <p className="mt-2">
              ...
              können personenbezogene Daten an andere Abteilungen oder Einheiten
          ...
          <section id="m24">
            ...
            <p className="mt-2">
              <strong>Datenverarbeitung in Drittländern:</strong> Sofern wir
              Daten in ein Drittland (d.h. außerhalb der Europäischen Union (EU)
              oder des Europäischen Wirtschaftsraums (EWR)) übermitteln oder
              dies im Rahmen der Nutzung von Diensten Dritter oder der
              Offenlegung bzw. Übermittlung von Daten an andere Personen,
              Stellen oder Unternehmen geschieht (was erkennbar wird anhand der
              Postadresse des jeweiligen Anbieters oder wenn in der
              Datenschutzerklärung ausdrücklich auf den Datentransfer in
              Drittländer hingewiesen wird), erfolgt dies stets im Einklang mit
            ...
            <p className="mt-2">
              ...
              Sollten sich Änderungen im Rahmen des DPF ergeben, greifen die
          ...
          <section id="m12">
            ...
            <p className="mt-2">
              ...
              nicht mehr benötigt werden. Ausnahmen von dieser Regelung
            ...
            <ul className="mt-2 list-inside list-disc space-y-2">
              <li>
                <strong>10 Jahre</strong> - Aufbewahrungsfrist für Bücher und
                Aufzeichnungen, Jahresabschlüsse, Inventare, Lageberichte,
                Eröffnungsbilanz sowie die zu ihrem Verständnis erforderlichen
                Arbeitsanweisungen und sonstigen Organisationsunterlagen (§ 147
                Abs. 1 Nr. 1 i.V.m. Abs. 3 AO, § 14b Abs. 1 UStG, § 257 Abs. 1
                Nr. 1 i.V.m. Abs. 4 HGB).
              </li>
              <li>
                <strong>8 Jahre</strong> - Buchungsbelege, wie z.B. Rechnungen
                und Kostenbelege (§ 147 Abs. 1 Nr. 4 und 4a i.V.m. Abs. 3 Satz 1
                AO sowie § 257 Abs. 1 Nr. 4 i.V.m. Abs. 4 HGB).
              </li>
              <li>
                <strong>6 Jahre</strong> - Übrige Geschäftsunterlagen:
                empfangene Handels- oder Geschäftsbriefe, Wiedergaben der
                abgesandten Handels- oder Geschäftsbriefe, sonstige Unterlagen,
                soweit sie für die Besteuerung von Bedeutung sind, z.B.
              ...
              <li>
                <strong>3 Jahre</strong> - Daten, die erforderlich sind, um
                potenzielle Gewährleistungs- und Schadensersatzansprüche oder
            ...
            <p className="mt-2">
              <strong>Fristbeginn mit Ablauf des Jahres:</strong> Beginnt eine
              Frist nicht ausdrücklich zu einem bestimmten Datum und beträgt sie
          ...
          <section id="m10">
            ...
            <p className="mt-2">
              <strong>Rechte der betroffenen Personen aus der DSGVO:</strong>{" "}
          ...
          <section id="m317">
            ...
            <p className="mt-2">
              ...
              ggf. Firma, Kontaktdaten wie E-Mail-Adresse und Telefonnummer,
            ...
            <p className="mt-2">
              ...
              Rechte sowie zur Erfüllung gesetzlicher Verpflichtungen. Dies
              umfasst insbesondere handels- und steuerrechtliche
              Aufbewahrungspflichten, Dokumentationspflichten sowie
              gegebenenfalls Nachweis- und Rechenschaftspflichten. Zudem erfolgt
              eine Verarbeitung auf Grundlage unserer berechtigten Interessen an
              einer ordnungsgemäßen Geschäftsführung, internen Verwaltung,
              Risikosteuerung und IT-Sicherheit sowie am Schutz unseres
              Geschäftsbetriebs und unserer Vertragspartner vor Missbrauch,
              Gefährdung von Daten, Geheimnissen und sonstigen Rechtsgütern.
              Hierzu kann auch die Einbindung externer Dienstleister wie IT- und
              Telekommunikationsanbieter, Transport- und Logistikunternehmen,
              Zahlungsdienstleister, Banken, Steuer- und Rechtsberater oder
              sonstige Erfüllungsgehilfen gehören, soweit dies für die
              Vertragsdurchführung oder zur Erfüllung gesetzlicher Pflichten
              erforderlich ist.
            </p>
            <p className="mt-2">
              Eine Weitergabe personenbezogener Daten an Dritte erfolgt
              ausschließlich, soweit dies zur Vertragserfüllung, zur
              Durchführung vorvertraglicher Maßnahmen, zur Wahrung berechtigter
              Interessen oder zur Erfüllung gesetzlicher Verpflichtungen
              erforderlich ist. Über darüberhinausgehende Verarbeitungen,
              insbesondere zu Marketingzwecken, informieren wir gesondert im
            ...
            <p className="mt-2">
              ...
              können eine längere Speicherung erfordern. Daten, die im Rahmen
              eines konkreten Auftrags übermittelt wurden, löschen wir nach
              Abschluss des Auftrags und Ablauf etwaiger Aufbewahrungsfristen,
              sofern keine weiteren gesetzlichen oder vertraglichen
              Verpflichtungen zur Speicherung bestehen.
            </p>
            <p className="mt-2">
              Rechtsgrundlage der Verarbeitung ist Art. 6 Abs. 1 lit. b DSGVO
              zur Durchführung vorvertraglicher Maßnahmen und zur Erfüllung des
              jeweiligen Vertragsverhältnisses sowie Art. 6 Abs. 1 lit. c DSGVO
              zur Erfüllung gesetzlicher Verpflichtungen. Soweit die
              Verarbeitung auf berechtigten Interessen beruht, erfolgt sie auf
              Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Soweit die Verarbeitung
              auf Art. 6 Abs. 1 lit. f DSGVO gestützt wird, erfolgt sie zur
              Wahrung unserer berechtigten Interessen an einer ordnungsgemäßen
              und effizienten Geschäftsorganisation, der internen Verwaltung und
              Dokumentation von Geschäftsvorgängen, der Durchsetzung und
              Verteidigung von Rechtsansprüchen, der Sicherstellung der IT- und
              Datensicherheit, der Verhinderung von Missbrauch und Betrug sowie
              der wirtschaftlichen Steuerung und Weiterentwicklung unseres
              Geschäftsbetriebs.
            </p>
            ...
            <ul className="mt-2 list-inside list-disc space-y-2">
              <li>
                <strong>Bildungs- und Schulungsleistungen:</strong> Wir
                ...
                erbringen zu können. Die hierbei verarbeiteten Daten, die Art,
                der Umfang, der Zweck und die Erforderlichkeit ihrer
                Verarbeitung bestimmen sich nach dem zugrundeliegenden Vertrags-
                und Schulungsverhältnis. Zu den Verarbeitungsformen gehören auch
                die Leistungsbewertung und die Evaluation unserer Leistungen
                sowie jener der Lehrenden. In Rahmen unserer Tätigkeit können
                wir ferner besondere Kategorien von Daten, hier insbesondere
                Angaben zur Gesundheit der Aus- und Fortzubildenden sowie Daten,
                aus denen die ethnische Herkunft, politische Meinungen,
                religiöse oder weltanschauliche Überzeugungen hervorgehen,
                verarbeiten. Hierzu holen wir, sofern erforderlich, eine
                ausdrückliche Einwilligung der Aus- und Fortzubildenden ein und
                verarbeiten die besonderen Kategorien von Daten ansonsten nur,
                ...
                erforderlich ist; <strong>Rechtsgrundlagen:</strong>{" "}
          ...
          <section id="m225">
            ...
            <ul className="mt-2 list-inside list-disc space-y-2">
              ...
              <li>
                ...
                mit dessen Hilfe Inhalte eines Onlineangebotes, insbesondere
                große Mediendateien, wie Grafiken oder Programm-Skripte, mit
                Hilfe regional verteilter und über das Internet verbundener
          ...
          <section id="m182">
            ...
            <ul className="mt-4 list-inside list-disc space-y-2">
              <li>
                ...
                (z.B. textliche oder bildliche Nachrichten und Beiträge sowie
                die sie betreffenden Informationen, wie z.B. Angaben zur
                Autorenschaft oder Zeitpunkt der Erstellung). Meta-,
                Kommunikations- und Verfahrensdaten (z.B. IP-Adressen,
                Zeitangaben, Identifikationsnummern, beteiligte Personen).
              </li>
              <li>
            ...
            <ul className="mt-2 list-inside list-disc space-y-2">
              <li>
                ...
                verarbeiten wir die uns übermittelten personenbezogenen Daten
          ...
          <section id="m2324">
            ...
            <p className="mt-2">
              ...
              Daten von Personen, die Hinweise geben (Hinweisgeber), sowie von
              betroffenen und beteiligten Parteien im Rahmen unseres
              Hinweisgeberverfahrens handhaben. Unser Ziel ist es, eine
              unkomplizierte und - Dieser Textbereich muss mit einer Premium
              Lizenz freischaltet werden.
            </p>
            <p className="mt-2">
              <strong>Rechtsgrundlagen (Deutschland):</strong> Soweit wir Daten
              zur Erfüllung unserer gesetzlichen Pflichten entsprechend dem
              Hinweisgeberschutzgesetz (HinSchG) verarbeiten, ist die rechtliche
              Basis der Verarbeitung Artikel 6 Abs. 1 S. 1 lit. c) DSGVO und im
              Fall besonderer Kategorien personenbezogener Daten Art. 9 Abs. 2
              lit. g) DSGVO, § 22 BDSG, jeweils in Verbindung mit § 10 HinSchG.
              Dies bezieht sich auf die Verpflichtung zur Einrichtung und zum
              Betrieb einer internen Hinweisgebermeldestelle, die Erfüllung
              ihrer gesetzlichen Aufgaben und, im Fall der Nutzung der im
              Meldeverfahren erhobenen Daten, das Ergreifen weiterer - Dieser
              Textbereich muss mit einer Premium Lizenz freischaltet werden.
            </p>
            <p className="mt-2">
              <strong>Verarbeitete Datenarten:</strong> Im Rahmen der
              Entgegennahme und Bearbeitung von Hinweisen sowie im
              anschließenden Hinweisgeber-Verfahren können wir verschiedene
              Daten erheben. Diese umfassen insbesondere die von einem
              Hinweisgeber bereitgestellten Daten, wie zum Beispiel: Name,
              Kontaktdaten und Aufenthaltsort der Person, die den Hinweis gibt,
              Namen und Daten zu möglichen Zeugen oder Personen, die von dem
              Hinweis betroffen sind, Namen und Daten zu den Personen, gegen die
              der Hinweis gerichtet ist, Daten über das mutmaßliche
              Fehlverhalten, Weitere relevante Details, sofern vom - Dieser
              Textbereich muss mit einer Premium Lizenz freischaltet werden.
            </p>
            <p className="mt-2">
              <strong>Besondere Kategorien personenbezogener Daten:</strong> Es
              kann vorkommen, dass wir im Rahmen unserer Tätigkeiten besondere
              Arten von personenbezogenen Daten erfassen, insbesondere dann,
              wenn diese von einem Hinweisgeber mitgeteilt werden. Dazu gehören:
              Gesundheitsbezogene Daten einer Person, Daten zur rassischen oder
              ethnischen Herkunft - Dieser Textbereich muss mit einer Premium
              Lizenz freischaltet werden.
            </p>
            <p className="mt-2">
              <strong>Nutzung unserer Onlineformulare:</strong> Bitte beachten
              Sie, dass die Möglichkeit besteht, Hinweise anonym abzugeben. Um
              die Sicherheit Ihrer Daten bei der Nutzung unserer
              Online-Formulare zu gewährleisten, empfehlen wir, diese im
              sogenannten "Inkognito-Modus" Ihres Browsers aufzurufen. So können
              Sie ein Inkognito-Fenster öffnen: a) Auf einem Windows-PC: Öffnen
              Sie Ihren Browser und drücken Sie Strg+Shift+N; b) Auf einem Mac:
              Öffnen Sie Ihren Browser und drücken Sie Command+Shift+N; c) Auf
              mobilen Endgeräten: Wechseln Sie über das Tab-Menü in den privaten
              Modus.
            </p>
            <p className="mt-2">
            ...
            <p className="mt-2">
              <strong>Angabe von Namen:</strong> Sie haben die Möglichkeit,
              Hinweise anonym abzugeben. Insofern es nicht durch nationale
              Gesetzgebungen untersagt ist, empfehlen wir jedoch die Angabe
              Ihres Namens und Ihrer Kontaktdaten. Dies ermöglicht uns, die
              Meldung effektiver nachzugehen und gegebenenfalls direkt mit Ihnen
              in Kontakt zu treten.
            </p>
            <p className="mt-2">
              Falls Sie Ihren Namen und Kontaktdaten angeben, wird Ihre
              Identität streng vertraulich - Dieser Textbereich muss mit einer
              Premium Lizenz freischaltet werden.
            </p>
            <p className="mt-2">
              <strong>Bereitstellung von Daten an Dritte:</strong> Daten, die im
              Zusammenhang mit den abgegebenen Hinweisen stehen, werden von uns
              nur unter bestimmten Umständen an Dritte weitergegeben. Dies
              geschieht entweder a) wenn Sie uns Ihre ausdrückliche Einwilligung
              dazu erteilt haben, oder b) wenn eine gesetzliche Verpflichtung
              zur Weitergabe der Daten besteht. Zu den möglichen Dritten gehören
              öffentliche Behörden, Regierungs-, Regulierungs- oder
              Steuerbehörden, falls die Weitergabe zur Erfüllung einer
              gesetzlichen oder regulatorischen Verpflichtung notwendig ist.
              Außerdem können wir im Rahmen gesetzlicher Bestimmungen
              Rechtsanwälte und andere Fachberater beauftragen. Diese sind dazu
              berechtigt, vermutetes Fehlverhalten zu prüfen und erforderliche
              Maßnahmen nach einer Untersuchung zu ergreifen, wie beispielsweise
              die Einleitung von Disziplinar- oder Gerichtsverfahren. Zudem
              können von uns sorgfältig ausgewählte und überwachte Dienstleister
              Daten zu diesen Zwecken erhalten (beispielsweise Betreiber eines
              webbasierten Meldesystems). Diese Dienstleister sind jedoch im
              Rahmen einer Auftragsdatenverarbeitung vertraglich zur Einhaltung
              der geltenden Datenschutzbestimmungen verpflichtet.
            </p>
            <p className="mt-2">
              <strong>Datenaufbewahrung und -löschung:</strong> Personenbezogene
              Daten werden nur so lange verarbeitet, wie es zur Erfüllung der
              oben beschriebenen Verarbeitungszwecke erforderlich ist. Sind
              diese Daten für die genannten Zwecke nicht mehr notwendig, erfolgt
              eine Löschung. In bestimmten Situationen können - Dieser
              Textbereich muss mit einer Premium Lizenz freischaltet werden.
            </p>
            <p className="mt-2">
              <strong>Technische und organisatorische Maßnahmen:</strong> Wir
              haben die erforderlichen vertraglichen, technischen und
              organisatorischen Maßnahmen implementiert, um die Sicherheit aller
              von uns verarbeiteten Daten zu gewährleisten. Diese Daten werden
              ausschließlich für die festgelegten Zwecke verarbeitet. Die
              eingehenden Hinweise werden von dazu - Dieser Textbereich muss mit
              einer Premium Lizenz freischaltet werden.
            </p>
            <ul className="mt-4 list-inside list-disc space-y-2">
              <li>
                <strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z.B.
                der vollständige Name, Wohnadresse, Kontaktinformationen,
                Kundennummer, - Dieser Textbereich muss mit einer Premium Lizenz
                freischaltet werden. - premiumtext premiumtext premiumtext );
                Beschäftigtendaten (Informationen zu Mitarbeitern und anderen
                Personen in einem - Dieser Textbereich muss mit einer Premium
                Lizenz freischaltet werden. - premiumtext premiumtext
                premiumtext ); Kontaktdaten (z.B. Post- und E-Mail-Adressen oder
                - Dieser Textbereich muss mit einer Premium Lizenz freischaltet
                werden. - premiumtext premiumtext premiumtext ); Inhaltsdaten
                (z.B. textliche oder bildliche Nachrichten und Beiträge sowie
                die sie betreffenden Informationen, wie z.B. Angaben zur
                Autorenschaft - Dieser Textbereich muss mit einer Premium Lizenz
                freischaltet werden. - premiumtext premiumtext premiumtext
                premiumtext premiumtext premiumtext ). Nutzungsdaten (z.B.
                Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität
                und -frequenz, verwendete Gerätetypen und Betriebssysteme,
                Interaktionen mit - Dieser Textbereich muss mit einer Premium
                Lizenz freischaltet werden. - premiumtext premiumtext
                premiumtext premiumtext premiumtext ).
              </li>
              <li>
                <strong>Betroffene Personen:</strong> Beschäftigte (z.B.
                Angestellte, Bewerber, Aushilfskräfte und sonstige - Dieser
                Textbereich muss mit einer Premium Lizenz freischaltet werden. -
                premiumtext premiumtext premiumtext ); Dritte Personen.
                Hinweisgeber.
              </li>
              <li>
                <strong>
              ...
              <li>
                ...
                S. 1 lit. a) DSGVO); Rechtliche Verpflichtung (Art. 6 Abs. 1 S.
                1 lit. c) DSGVO). Berechtigte Interessen (Art. 6 Abs. 1 S. 1
                lit. f) DSGVO).
              </li>
            </ul>
          </section>
          ...
          <section id="m42">
            ...
            <ul className="mt-2 list-inside list-disc space-y-2">
              <li>
                ...
                bezeichnet, die in einem Beschäftigungsverhältnis stehen, sei es
                als Mitarbeiter, Angestellte oder in ähnlichen Positionen. Ein
              ...
              <li>
                ...
                ähnlichen Zuordnungen notwendig sind. Diese Daten können u.a.
                ...
                (Benutzer-IDs) beinhalten. Bestandsdaten bilden die Grundlage
                für jegliche formelle Interaktion zwischen Personen und
              ...
              <li>
                ...
                selbst liefern, wie Tags, Beschreibungen, Autoreninformationen
              ...
              <li>
                ...
                umfassen eine breite Palette von Informationen, die aufzeigen,
                wie Nutzer Anwendungen nutzen, welche Funktionen sie bevorzugen,
                wie lange sie auf bestimmten Seiten verweilen und über welche
                Pfade sie durch eine Anwendung navigieren. Nutzungsdaten können
                auch die Häufigkeit der Nutzung, Zeitstempel von Aktivitäten,
                IP-Adressen, Geräteinformationen und Standortdaten einschließen.
                Sie sind besonders wertvoll für die Analyse des
                Nutzerverhaltens, die Optimierung von Benutzererfahrungen, das
                Personalisieren von Inhalten und das Verbessern von Produkten
                oder Dienstleistungen. Darüber hinaus spielen Nutzungsdaten eine
              ...
              <li>
                ...
                Informationen über Ereignisse oder Aktivitäten, die in einem
                System oder Netzwerk protokolliert wurden. Diese Daten enthalten
                typischerweise Informationen wie Zeitstempel, IP-Adressen,
                Benutzeraktionen, Fehlermeldungen und andere Details über die
                Nutzung oder den Betrieb eines Systems. Protokolldaten werden
                oft zur Analyse von Systemproblemen, zur Sicherheitsüberwachung
              ...
              <li>
                ...
                Informationen, die sich auf die Formalisierung einer
                Vereinbarung zwischen zwei oder mehr Parteien beziehen. Sie
                dokumentieren die Bedingungen, unter denen Dienstleistungen oder
                Produkte bereitgestellt, getauscht oder verkauft werden. Diese
                Datenkategorie ist wesentlich für die Verwaltung und Erfüllung
                vertraglicher Verpflichtungen und umfasst sowohl die
                Identifikation der Vertragsparteien als auch die spezifischen
                Bedingungen und Konditionen der Vereinbarung. Vertragsdaten
                können Start- und Enddaten des Vertrages, die Art der
              ...
              <li>
                ...
                sind von entscheidender Bedeutung für den elektronischen Handel,
                das Online-Banking und jede andere Form der finanziellen
                ...
                können auch Informationen über den Zahlungsstatus,
                Rückbuchungen, Autorisierungen und Gebühren enthalten.
              </li>
            </ul>
          </section>
